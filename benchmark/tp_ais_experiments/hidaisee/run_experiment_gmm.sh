...
tmux split-window "python3 run_benchmark.py tp_ais_experiments/benchmarks/def_benchmark_gmm_4D.yaml \
...
tmux split-window "python3 run_benchmark.py tp_ais_experiments/benchmarks/def_benchmark_gmm_5D.yaml \
tp_ais_experiments/hidaisee/def_methods_HD60.yaml tp_ais_experiments/hidaisee/def_config.yaml \
tp_ais_experiments/hidaisee/results_gmm_HD60_5D.txt  2>tp_ais_experiments/hidaisee/results_gmm_HD60_5D_err.txt; read"

tmux split-window "python3 run_benchmark.py tp_ais_experiments/benchmarks/def_benchmark_gmm_6D.yaml \
tp_ais_experiments/hidaisee/def_methods_HD60.yaml tp_ais_experiments/hidaisee/def_config.yaml \
